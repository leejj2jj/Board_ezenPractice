...
<script>
	function fn_go_list() {
		...
		// http://localhost:8888/list?page=1&perPageNum=10&searchType=t&keyword=자바
		location.href = "/list" + '${pageMaker.makeQuery(1)}' + '&searchType='
	...
	<main class="flex-shrink-0">
		<div class="container">
						...
						<tbody>
							<c:forEach items="${list}" var="vo">
								<tr>
									...
									<td><a href="/readPage?bno=${vo.bno}">${vo.title}</a></td>
									<td>${vo.writer}</td>
			...
			<div class="row">
				...
				<div class="col-1">
					<button type="button" class="btn btn-info" onclick="fn_go_list()">검색</button>
				</div>
